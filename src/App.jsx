...
function App() {
  ...
  function changeColor() {
    const colors = ['#4CAF50', '#FFC107', '#F44336', '#2196F3', '#9C27B0', '#FF5722', '#3F51B5', '#00BCD4', '#8BC34A', '#E91E63', '#795548', '#9E9E9E'];
  ...
  const xLink = `https://twitter.com/intent/tweet?hashtags=quotes&related=freecodecamp&text=%22${encodeURIComponent(versiculoData.versiculo)}%22%20-${encodeURIComponent(versiculoData.localizacao)}`;
